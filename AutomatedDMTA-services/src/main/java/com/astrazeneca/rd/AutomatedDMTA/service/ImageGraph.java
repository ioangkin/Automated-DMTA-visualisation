...
import javax.persistence.Lob;
	...
	/**
	* The serializable class ImageGraph does not declare a static final serialVersionUID field of type long
	* A version number associated by the serialization runtime, deserialization verifies that the sender and receiver of a serialized object have loaded classes for that object that are compatible with respect to serialization
	*/
