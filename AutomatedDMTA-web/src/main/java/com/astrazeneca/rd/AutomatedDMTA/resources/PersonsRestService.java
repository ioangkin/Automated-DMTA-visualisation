...
public class PersonsRestService {
	...
	@Path("/search")
	@Consumes(MediaType.APPLICATION_JSON)
	public List<Person> search(@DefaultValue("and") @QueryParam("op") String op,
			@QueryParam("firstName") String firstName, @QueryParam("lastName") String lastName) throws Exception {
