...
angular.module('myApp.compound', ['ngResource'])
    ...
    // Get the Structure graph modal
       var structModal = document.getElementById('struct_graph_modal');
       ...
       var lineModal = document.getElementById('line_graph_modal');

       // Get the image and insert it inside the modal - use its "alt" text as a caption
       var img = document.getElementById('line_graph');
